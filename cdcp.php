            ...
            <section id="subheader" class="position-relative overflow-hidden" style="padding: 0; height: 500px;">
                ...
                <div class="container z-1 text-center text-white about-header"
                    ...
                    <div class="row align-items-center" style="margin-top:100px;">
                        <div class="col-lg-12">
                            <h2 class="wow fadeInUp fs-4 mb-4" data-wow-delay=".2s">Canadian Dental Care Plan (CDCP)
                            </h2>
                            <h1 class="wow fadeInUp mb-5">CDCP</h1>
                            ...
                            <div class="col-sm-12">
                                <div class=" rounded-1 overflow-hidden wow zoomIn  image-container">
                                    <picture>
                                        ...
                                        <img src="images/about/p4-1280.webp" class="w-100 wow scaleIn  responsive-img"
                                            loading="lazy" alt="About us">
                                    </picture>
                                </div>
                            </div>
