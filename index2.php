                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="swiper-inner"
                                        data-bgimage="url(<?php echo $root; ?>assets/images/homepage/slider/1-1280.webp) center"
                                        loading="lazy">
                                ...
                                <div class="swiper-slide">
                                    <div class="swiper-inner"
                                        data-bgimage="url(<?php echo $root; ?>assets/images/homepage/slider/2-1280.webp) center"
                                        loading="lazy">
                                        <div class="sw-overlay op-5"></div>
                                        <div class="gradient-edge-left z-2"></div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="swiper-inner"
                                        data-bgimage="url(<?php echo $root; ?>assets/images/homepage/slider/3-1280.webp) center"
                                        loading="lazy">
                                        <div class="sw-overlay op-5"></div>
                                        <div class="gradient-edge-left z-2"></div>
                                    </div>
                    ...
                    <div class="row g-4 grid-divider" style="background-size: cover; background-repeat: no-repeat;">
                        <div class="col-lg-4 col-md-6 mb-sm-30">
                            <div class="d-flex align-items-center icons">
                                ...
                                <div class="ms-3">
                                    <h4 class="mb-0">Need Dental Assistance? Call us Now!</h4>
                                    <p><a href="tel:(+1) 234-5678">Call: (+1) 234-5678</a></p>
                                </div>
                            </div>
                        </div>
