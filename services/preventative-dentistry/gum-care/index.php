...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>services/preventative-dentistry/gum-care/">

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Teeth Cleaning & Gum Care in Toronto | Crossroads Dental">
    ...
    <meta name="twitter:title" content="Teeth Cleaning & Gum Care in Toronto | Crossroads Dental">
                            ...
                            <div class="service-img mb-4">
                                <picture style="width: 100%; height: 100%; object-fit: cover; display: block;">
                                    ...
                                    <img src="<?php echo $root; ?>/assets/images/services/banner/gum_care-1280.webp"
                                        alt="Is It Time for a Dental Cleaning?" loading="lazy"
                                        class="img-fluid">
                                </picture>
                            </div>
