...
<head>
    ...
    <title>Oral Cancer Screenings in Toronto | Crossroads Dental</title>
    <meta name="title" content="Oral Cancer Screenings in Toronto | Crossroads Dental">
    <meta name="description"
        content="Early detection saves lives. Book an oral cancer screening at Crossroads Dental in Toronto that's quick, painless, and part of every routine exam.">
    <meta name="author" content="Crossroads">
    <link rel="canonical" href="<?php echo $root;?>services/preventative-dentistry/oral-cancer-screening/">

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Oral Cancer Screenings in Toronto | Crossroads Dental">
    <meta property="og:description"
        content="Early detection saves lives. Book an oral cancer screening at Crossroads Dental in Toronto that's quick, painless, and part of every routine exam.">
    <meta property="og:image" content="<?php echo $root; ?>assets/images/openGraph/Oral-screening.png">

    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta property="twitter:domain" content="crossroadsdental.ca">
    <meta property="twitter:url" content="">
    <meta name="twitter:title" content="Oral Cancer Screenings in Toronto | Crossroads Dental">
    <meta name="twitter:description"
        content="Early detection saves lives. Book an oral cancer screening at Crossroads Dental in Toronto that's quick, painless, and part of every routine exam.">
    <meta name="twitter:image" content="<?php echo $root; ?>assets/images/openGraph/Oral-screening.png">
                        ...
                        <div class="breadcrumbs">
                            <ul class="crumb wow fadeInDown">
                                ...
                                <li><a href="<?php echo $root; ?>services/preventative-dentistry/">Preventative
                                        Dentistry</a></li>
                                <li class="active">Oral Cancer Screening</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-9 main-content">
                            ...
                            <div class="service-img mb-4">
                                <picture style="width: 100%; height: 100%; object-fit: cover; display: block;">
                                    <source
                                        srcset="<?php echo $root; ?>/assets/images/services/banner/oral_screening-480.webp"
                                        media="(max-width: 600px)">
                                    <source
                                        srcset="<?php echo $root; ?>/assets/images/services/banner/oral_screening-768.webp"
                                        media="(max-width: 992px)">
                                    <img src="<?php echo $root; ?>/assets/images/services/banner/oral_screening-1280.webp"
                                        alt="Have You Had Your Oral Cancer Screening This Year?" loading="lazy" class="img-fluid">
                                </picture>
                            </div>

                            <section class="pt-0 pb-0">
                                <div class="service-items">
                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">Why Oral Cancer Screening is Important
                                    </h3>
                                    <p>Oral cancer can affect the lips, tongue, cheeks, throat, and gums. It often
                                        develops without noticeable symptoms in its early stages. Regular screenings
                                        help us catch warning signs early which is when treatment is most effective.</p>

                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">Who Should Be Screened?</h3>
                                    <p>While everyone benefits from routine screening, it’s especially important if you:
                                    </p>
                                    <ul class="ul-check fw-500 mb-4 wow fadeInUp" data-wow-delay=".6s">
                                        <li class="mb-4">Are over age 40</li>
                                        <li class="mb-4">Use tobacco or alcohol regularly</li>
                                        <li class="mb-4">Have a history of HPV or oral cancer</li>
                                        <li class="mb-4">Experience persistent sores, lumps, or difficulty swallowing
                                        </li>
                                    </ul>
                                    <p>Even if you don’t have risk factors, screening is a key part of preventive care.
                                    </p>

                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">What Happens During a Screening?</h3>
                                    <p>Oral cancer screenings are quick, non-invasive, and painless. During your dental
                                        exam, we will:</p>
                                    <ul class="ul-check fw-500 mb-4 wow fadeInUp" data-wow-delay=".6s">
                                        <li class="mb-4">Visually inspect your lips, tongue, cheeks, gums, and throat
                                        </li>
                                        <li class="mb-4">Gently feel for any unusual lumps, sores, or tissue changes
                                        </li>
                                        <li class="mb-4">Use a special light or device (if needed) for enhanced
                                            visibility</li>
                                    </ul>
                                    <p>The entire process takes just a few minutes and can be done at your regular
                                        check-up.</p>

                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">What If We Find Something?</h3>
                                    <p>If we notice anything unusual, we’ll explain our findings and refer you for
                                        further evaluation if necessary. Most findings are harmless but if it’s
                                        something serious, catching it early could make all the difference.</p>

                                    <h3 class="wow fadeInUp" data-wow-delay=".2s">Take a Proactive Approach to Your
                                        Health</h3>
                                    <p>At Crossroads Dental, your overall well-being matters to us. That’s why we
                                        include oral cancer screenings as a standard part of your care because
                                        prevention starts with awareness.</p>

                                    <p><strong>Schedule your dental exam and oral cancer screening at Crossroads Dental
                                            in Toronto today.</strong></p>
                                    <div class="educational-video single mb-4">
                                        <h3>Things to Know About Oral Cancer</h3>
                                        <a href="//fast.wistia.net/embed/iframe/2gavhsc6gx?popover=true"
                                            class="wistia-popover[height=360,playerColor=8c8c8c,width=640]"><img
                                                src="https://www.deardoctor.com/images/video-gallery/play/top5-oral-cancer.jpg"
                                                width="650" alt="Things to Know About Oral Cancer"></a>
                                            ...
                                            <div class="accordion s2 wow fadeInUp animated">
                                                <div class="accordion-section">
                                                    ...
                                                    <div class="accordion-section-content" id="accordion-c1">
                                                        It’s a quick, non-invasive check during your dental exam where
                                                    ...
                                                    <div class="accordion-section-content" id="accordion-c2">
                                                        Everyone can benefit, but it's especially important if you're
                                                    ...
                                                    <div class="accordion-section-content" id="accordion-c4">
                                                        We’ll discuss our findings and refer you to a specialist for
                                                    ...
                                                    <div class="accordion-section-content" id="accordion-c5">
                                                        While it can’t always be prevented, avoiding tobacco, limiting
                                                        alcohol, and getting regular screenings helps reduce risk and
                                                        catch signs early.
                                                    </div>
                                                </div>
                                            </div>
