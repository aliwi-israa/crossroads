...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>services/general-dentistry/pediatric/">

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Pediatric Dentistry in Toronto | Crossroads Dental">
    ...
    <meta name="twitter:title" content="Pediatric Dentistry in Toronto | Crossroads Dental">
                            ...
                            <div class="service-img mb-4">
                                <picture style="width: 100%; height: 100%; object-fit: cover; display: block;">
                                    ...
                                    <img src="<?php echo $root; ?>/assets/images/services/banner/pediatric-1280.webp"
                                        alt="Looking for a Kid-Friendly Dentist in Toronto?" loading="lazy" class="img-fluid">
                                </picture>
                            </div>
                            <section class="pt-0 pb-0">
                                <div class="service-items">
                                    ...
                                    <div class="educational-video single mb-4">
										...
										<a href="//fast.wistia.net/embed/iframe/uk2n3ml6ys?popover=true" class="wistia-popover[height=360,playerColor=8c8c8c,width=640]"><img src="https://www.deardoctor.com/images/video-gallery/play/pediatric-dentistry.jpg" width="650" alt="Things to Know about Paediatric Dentistry"></a><script charset="ISO-8859-1" src="//fast.wistia.com/assets/external/popover-v1.js"></script>
									</div>
                                </div>
                            </section>
