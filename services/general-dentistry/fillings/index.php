...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>services/general-dentistry/fillings/">
                ...
                <div class="container relative z-2" >
                    <div class="row align-items-center" >
                        <div class="col-lg-12" >
                            ...
                            <h1 class="wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">Dental Fillings in Toronto</h1>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-md-9 main-content">
                            <div class="title-wrap">
                                <div class="subtitle id-color wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <h2 class="id-color service-header">Tooth Pain or Sensitivity? It Might Be a Cavity.</h2>
