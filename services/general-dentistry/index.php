...
<head>
    ...
    <title>General Dentistry in Toronto | Crossroads Dental</title>
    <meta name="title" content="General Dentistry in Toronto | Crossroads Dental">
                ...
                <div class="container relative z-2" >
                    <div class="row align-items-center" >
                        <div class="col-lg-12" >
                            ...
                            <h1 class="wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">General Dentistry in Toronto</h1>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 main-content">
                            <div class="title-wrap">
                                ...
                                <h2 class="id-color service-header">Need Reliable Dental Care in Toronto?</h2>
