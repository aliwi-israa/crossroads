...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>services/cosmetic-dentistry/smile-makeover/">

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Smile Makeover in Toronto | Crossroads Dental">
    ...
    <meta name="twitter:title" content="Smile Makeover in Toronto | Crossroads Dental">
                ...
                <div class="container relative z-2" >
                    <div class="row align-items-center" >
                        <div class="col-lg-12" >
                            ...
                            <h1 class="wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">Smile Makeovers in Toronto</h1>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 main-content">
                            <div class="title-wrap">
                                ...
                                <h2 class="id-color service-header">Dreaming of a New Smile?</h2>
