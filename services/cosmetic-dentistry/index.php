...
<head>
    ...
    <meta property="og:title" content="Cosmetic Dentistry in Toronto | Crossroads Dental">
    ...
    <meta name="twitter:title" content="Cosmetic Dentistry in Toronto | Crossroads Dental">
                ...
                <div class="container relative z-2" >
                    <div class="row align-items-center" >
                        <div class="col-lg-12" >
                            ...
                            <h1 class="wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">Cosmetic Dentistry in Toronto</h1>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 main-content">
                            <div class="title-wrap">
                                ...
                                <h2 class="id-color service-header">Dreaming of a More Confident Smile?</h2>
                            ...
                            <div class="educational-video single mb-4">
                                ...
                                <a href="//fast.wistia.net/embed/iframe/ea8qm1ez8b?popover=true"
                                    class="wistia-popover[height=360,playerColor=8c8c8c,width=640]"><img
                                        ...
                                        width="650" alt="Things to Know about Dental Bonding"></a>
                                            ...
                                            <a href="<?php echo $root; ?>services/cosmetic-dentistry/teeth-whitening/">
                                                <div class="services-icons">
                                                    <img src="<?php echo $root; ?>assets/images/icons/icons-whitening.svg"
                                                        class="w-100 wow scaleIn" alt="Teeth Whitening">
                                            ...
                                            <a href="<?php echo $root; ?>services/cosmetic-dentistry/veneers/">
                                                <div class="services-icons">
                                                    <img src="<?php echo $root; ?>assets/images/icons/icons-veneers-cosmetic.svg"
                                                        class="w-100 wow scaleIn" alt="Dental Veneers">
                                            ...
                                            <a href="<?php echo $root; ?>services/cosmetic-dentistry/bonding/">
                                                <div class="services-icons">
                                                    <img src="<?php echo $root; ?>assets/images/icons/icons-dental-bonding.svg"
                                                        class="w-100 wow scaleIn" alt="Dental Bonding">
                                            ...
                                            <a href="<?php echo $root; ?>services/cosmetic-dentistry/smile-makeover/">
                                                <div class="services-icons">
                                                    <img src="<?php echo $root; ?>assets/images/homepage/icons/smile-makeover.svg"
                                                        class="w-100 wow scaleIn" alt="Smile Makeovers">
