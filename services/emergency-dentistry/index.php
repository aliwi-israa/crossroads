...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>services/emergency-dentistry/">

    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Emergency Dentist in Toronto | Crossroads Dental">
    ...
    <meta name="twitter:title" content="Emergency Dentist in Toronto | Crossroads Dental">
                ...
                <div class="container relative z-2" >
                    <div class="row align-items-center" >
                        <div class="col-lg-12" >
                            ...
                            <h1 class="wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">Emergency Dentist in Toronto</h1>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 main-content">
                            <div class="title-wrap">
                                ...
                                <h2 class="id-color service-header">Dental Emergency? We’re Here When You Need Us.</h2>
                            ...
                            <div class="educational-video single mb-4">
                                ...
                                <a href="//fast.wistia.net/embed/iframe/pjkwm6m89d?popover=true"
                                    class="wistia-popover[height=360,playerColor=8c8c8c,width=640]"><img
                                        ...
                                        width="650" alt="Emergency Dentistry Explained"></a>
