            ...
            <div class="container">
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                        <div class="widget">
                            <h5>Contact Us</h5>
                            <a href="https://www.google.com/maps?q=2384+Dundas+St+W" target="_blank" class="text-white text-decoration-none d-block fw-bold">
                        ...
                        <div class="col-md-12">
                            <div class="de-flex">
                                <div class="de-flex-col">
                                    Copyright 2025 - Crossroads Dental by Designesia
                                </div>
