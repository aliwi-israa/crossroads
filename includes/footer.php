    ...
    <div class="container">
        <div class="row gx-5">
            <div class="col-lg-4 col-sm-6">
                <img src="<?php echo $root; ?>assets/images/crosroads-dental-clinic-logo-white.webp" class="logo-footer"
                    alt="">
                <div class="spacer-20"></div>
                <p>At Crossroads Dental, we’re dedicated to providing high-quality, personalized dental care for
                    patients of all ages. Our skilled team uses the latest technology to ensure comfortable, efficient
                    treatments and beautiful, healthy smiles for life.</p>
                <div class="social-icons mb-sm-30">
                    <a href="<?php echo $config['ClinicFacebook'] ?: 'https://www.facebook.com/'; ?>" target="_blank"
                        aria-label="Facebook">
                    ...
                    <a href="<?php echo $config['ClinicInstagram'] ?: 'https://www.instagram.com/accounts/login/'; ?>"
                        target="_blank" aria-label="Instagram Login">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo $root; ?>services/emergency-dentistry/">Emergency Dentistry</a>
                                </li>
            ...
            <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                <div class="widget">
                    <h5>Contact Us</h5>
                    <a href="<?php echo $config['ClinicMapLink'] ?: 'https://www.google.com/maps/'; ?>" target="_blank"
                        class="text-white text-decoration-none d-block fw-bold">
                        <i class="fa-solid fa-location-dot me-2 id-color fs-14"></i>
                        Clinic Location
                        <div class="fw-normal text-white ms-4">
                            <?php echo $config['ClinicAddress'] ?: '2384 Dundas St W'; ?></div>
                    </a>
                    <div class="spacer-20"></div>
                    <a href="tel:<?php echo $config['ClinicPhoneNumber'] ?: '(+1) 234-5678'; ?>"
                        ...
                        <div class="fw-normal text-white ms-4">
                            <?php echo $config['ClinicPhoneNumber'] ?: '(+1) 234-5678'; ?></div>
                    </a>
                    <div class="spacer-20"></div>
                    <a href="mailto:<?php echo $config['ClinicEmail'] ?: 'info@crossroadsdental.ca'; ?>"
                        class="text-white text-decoration-none d-block fw-bold">
                        <i class="fa fa-envelope me-2 id-color fs-14"></i>Send a Message
                        <div class="fw-normal text-white ms-4">
                            <?php echo $config['ClinicEmail'] ?: 'info@crossroadsdental.ca'; ?></div>
                    </a>
                </div>
            </div>
        </div>
