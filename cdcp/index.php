...
<head>
    ...
    <link rel="canonical" href="<?php echo $root;?>cdcp/">
            ...
            <section>
                <div class="container">
                    <div class="row g-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="ms-lg-3">
                                <div class="subtitle s2 mb-3 wow fadeInUp">CDCP</div>
                                <h2 class="wow fadeInUp">Understanding CDCP</h2>
            ...
            <section class="bg-color bg-color-op-1">
                <div class="container">
                    <div class="row g-4 gx-5 align-items-center flex-row-reverse">
                        ...
                        <div class="col-lg-6">
                            <div class="ms-lg-3">
                                <h2 class="wow fadeInUp">What is CDCP?</h2>
                                <p class="wow fadeInUp">
            ...
            <section>
                <div class="container">
                    <div class="row g-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="ms-lg-3">
                                <h2 class="wow fadeInUp">Who is Eligible?</h2>
                                <p class="wow fadeInUp">
                                    To benefit from the CDCP, you must:
                                </p>
            ...
            <section>
                <div class="container">
                    <div class="row g-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="ms-lg-3">
                                <h2 class="wow fadeInUp">What’s Covered?</h2>
                                <p class="wow fadeInUp">
                                    Under CDCP, eligible patients can receive:
                                </p>
                                <ul class="wow fadeInUp">
