            ...
            <section id="subheader" class="bg-color-op-1 text-center">
                <div class="container relative z-2">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <h3 class="wow fadeInUp animated subheader">What to Expect?</h3>
                            <h1 class="wow fadeInUp animated">What New Patients Need to Know</h1>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p1-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p1-768.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/patients/p1-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy"
                                            alt="New to Crossroads Dental?">
                                    </picture>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="me-lg-3">
                                ...
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    We’re excited to welcome you to Crossroads Dental! Whether it’s been a while since
                                    your last visit or you’re starting fresh with us, our friendly team is here to make
                                    your experience smooth, comfortable, and positive from day one.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p2-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p2-768.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/patients/p2-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy"
                                            alt="What to Expect at Your First Visit">
                                    </picture>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 gx-5 align-items-center">
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/about/p3-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/about/p3-768.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/about/p3-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy" alt="What to Bring">
                                    </picture>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 gx-5 align-items-center">
                        <div class="col-lg-6">
                            <div class="me-lg-3">
                                ...
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    We accept most major dental insurance plans and will help you understand your
                                    coverage. If you’re not insured, we offer flexible payment options and can help you
                                    plan your treatment schedule accordingly.
                                </p>
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    Ask us about:
                                </p>
                        ...
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p5-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p5-768.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/patients/p5-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy"
                    ...
                    <div class="row g-4 gx-5 align-items-center">
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p4-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p4-768.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/patients/p4-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy"
                                            alt="Book Your First Visit">
                                    </picture>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="me-lg-3">
                                ...
                                <ul class="ul-check text-dark fw-600 mb-4 wow fadeInUp" data-wow-delay=".6s">
                                    <li class="mb-4">Call us at <a class="text-blue"
                                            href="tel:<?php echo $config['ClinicPhoneNumber'] ?: '(+1) 234-5678'; ?>"><?php echo $config['ClinicPhoneNumber'] ?: '(+1) 234-5678'; ?></a>
                                    </li>
                                    <li class="mb-4"><a href="<?php  echo $config['ClinicBookingLink']; ?>"
                                            class="text-blue" data-hover=" Book Appointment"><span>Book
                                                online</span></a></li>
                                    <li class="mb-4">Or use our <a class="text-blue"
                                            href="<?php echo $root; ?>contact/">Contact Form</a></li>
                                </ul>
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    We offer convenient hours, same-day appointments, and evening visits to fit your
                                    schedule.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 gx-5 align-items-center">
                        <div class="col-lg-6">
                            <div class="me-lg-3">
                                ...
                                <p class="wow fadeInUp" data-wow-delay=".4s">
                                    <strong>Questions? We’re Here to Help</strong><br /> Check out our <a
                                        class="text-blue" href="<?php echo $root; ?>faq/">FAQs</a> or give us a call.
                                    We’re always happy to walk you through your first visit, insurance concerns, or any
                                    special requests.
                                </p>
                                <a href="<?php echo $config['ClinicBookingLink']; ?>"
                                    class="btn-main fx-slide wow fadeInUp" data-wow-delay=".6s"><span>Book Your First
                                        Visit</span></a>
                                <p class="wow fadeInUp mt-4" data-wow-delay=".4s">
                                    Start your journey to better oral health now. Book your first visit at Crossroads
                                    Dental today!
                                </p>
                        ...
                        <div class="col-lg-6">
                            <div class="col-sm-12">
                                <div class="rounded-1 overflow-hidden wow zoomIn image-container">
                                    <picture>
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p6-480.webp"
                                            media="(max-width: 600px)">
                                        <source srcset="<?php echo $root; ?>assets/images/patients/p6-780.webp"
                                            media="(max-width: 992px)">
                                        <img src="<?php echo $root; ?>assets/images/patients/p6-1280.webp"
                                            class="w-100 wow scaleIn responsive-img" loading="lazy"
                                            alt="Have questions?">
                                    </picture>
                                </div>
